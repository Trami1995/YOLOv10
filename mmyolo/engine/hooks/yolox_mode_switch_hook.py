...
class YOLOXModeSwitchHook(Hook):
    ...
    def before_train_epoch(self, runner: Runner):
        ...
        if (epoch + 1) == runner.max_epochs - self.num_last_epochs:
            ...
            if train_dataloader_cfg.dataset.type == 'ConcatDataset':
                for single_dataloader in train_dataloader_cfg.dataset.datasets:
                    single_dataloader.pipeline = self.new_train_pipeline_cfg
            else:
